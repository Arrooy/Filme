...
public class DB {
    ...
    public DBR getFilmDescription(String filmName, Fallback<MovieInfo> fallback) throws MovieDbException {
    ...
    public DBR getFilmDate(String filmName, Fallback<MovieInfo> fallback) throws MovieDbException {
        ResultList<MovieInfo> res = dbApi.searchMovie(filmName, 0, "en-US", false, 0, 0, SearchType.NGRAM);
    ...
    public DBR getMovieReview(String filmName, Fallback<MovieInfo> fallback) throws MovieDbException {
        ResultList<MovieInfo> res = dbApi.searchMovie(filmName, 0, "en-US", false, 0, 0, SearchType.NGRAM);
