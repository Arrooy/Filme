...
class SpellingPeterNorvig {

    private final HashMap<String, Integer> nWords = new HashMap<String, Integer>();

    public SpellingPeterNorvig(String file) throws IOException {
    ...
    public static void main(String args[]) throws IOException {
        System.out.println((new SpellingPeterNorvig("res/words_alpha.txt")).correct("korrectud"));
    }
